...
export class TripController {
  ...
  async listTrips(@Req() request: Request) {
    // const userID = request['user'].sub; // UNCOMMENT WHEN AUTHENTICATION IS ENABLED

    // const trips = await this.tripService.getTrips(userID); // UNCOMMENT WHEN AUTHENTICATION IS ENABLED
  ...
  async addTrip(@Body() requestBody: TripDTO, @Req() request: Request) {
    ...
    // const id = await this.tripService.createTrip(tripCreationProps, userID); // UNCOMMENT WHEN AUTHENTICATION IS ENABLED
